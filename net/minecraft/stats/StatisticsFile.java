...
public class StatisticsFile extends StatFileWriter {
   ...
   public void readStatFile() {
      if(this.statsFile.isFile()) {
         try {
            ...
            logger.error((String)("Couldn\'t read statistics file " + this.statsFile), (Throwable)var2);
         } catch (JsonParseException var3) {
            logger.error((String)("Couldn\'t parse statistics file " + this.statsFile), (Throwable)var3);
         }
      }
   ...
   public Set func_150878_c() {
      Set<StatBase> set = Sets.newHashSet((Iterable)this.field_150888_e);
