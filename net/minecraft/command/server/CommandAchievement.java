               ...
               if(statbase == null) {
                  ...
                  if(statbase instanceof Achievement) {
                     ...
                     if(flag) {
                        ...
                        List<Achievement> list1 = Lists.newArrayList((Iterator)Iterators.filter(AchievementList.achievementList.iterator(), new Predicate() {
                        ...
                        List<Achievement> list2 = Lists.newArrayList((Iterable)list1);
