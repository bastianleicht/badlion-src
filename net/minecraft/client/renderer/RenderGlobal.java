...
public class RenderGlobal implements IWorldAccess, IResourceManagerReloadListener {
   ...
   public void makeEntityOutlineShader() {
      if(OpenGlHelper.shadersSupported) {
         ...
         try {
            ...
            logger.warn((String)("Failed to load shader: " + resourcelocation), (Throwable)var3);
            this.entityOutlineShader = null;
            this.entityOutlineFramebuffer = null;
         } catch (JsonSyntaxException var4) {
            logger.warn((String)("Failed to load shader: " + resourcelocation), (Throwable)var4);
            this.entityOutlineShader = null;
            this.entityOutlineFramebuffer = null;
         }
      } else {
   ...
   public void setupTerrain(Entity viewEntity, double partialTicks, ICamera camera, int frameCount, boolean playerSpectator) {
      ...
      if(!flag && this.displayListEntitiesDirty) {
         ...
         if(renderchunk != null) {
            boolean flag2 = false;
            RenderGlobal.ContainerLocalRenderInformation renderglobal$containerlocalrenderinformation3 = new RenderGlobal.ContainerLocalRenderInformation(renderchunk, (EnumFacing)null, 0, (RenderGlobal.ContainerLocalRenderInformation)null);
            ...
            for(int j = -this.renderDistanceChunks; j <= this.renderDistanceChunks; ++j) {
               for(int k = -this.renderDistanceChunks; k <= this.renderDistanceChunks; ++k) {
                  ...
                  if(renderchunk1 != null && ((ICamera)camera).isBoundingBoxInFrustum(renderchunk1.boundingBox)) {
                     ...
                     queue.add(new RenderGlobal.ContainerLocalRenderInformation(renderchunk1, (EnumFacing)null, 0, (RenderGlobal.ContainerLocalRenderInformation)null));
                  }
               }
            }
         }
         ...
         while(!((Queue)queue).isEmpty()) {
            ...
            EnumFacing[] var32;
            for(EnumFacing enumfacing1 : var32 = EnumFacing.values()) {
               ...
               if((!flag1 || !renderglobal$containerlocalrenderinformation1.setFacing.contains(enumfacing1.getOpposite())) && (!flag1 || enumfacing2 == null || renderchunk3.getCompiledChunk().isVisible(enumfacing2.getOpposite(), enumfacing1)) && renderchunk2 != null && renderchunk2.setFrameIndex(frameCount) && ((ICamera)camera).isBoundingBoxInFrustum(renderchunk2.boundingBox)) {
                  RenderGlobal.ContainerLocalRenderInformation renderglobal$containerlocalrenderinformation = new RenderGlobal.ContainerLocalRenderInformation(renderchunk2, enumfacing1, renderglobal$containerlocalrenderinformation1.counter + 1, (RenderGlobal.ContainerLocalRenderInformation)null);
   ...
   class ContainerLocalRenderInformation {
      ...
      // $FF: synthetic method
      ContainerLocalRenderInformation(RenderChunk var2, EnumFacing var3, int var4, RenderGlobal.ContainerLocalRenderInformation var5) {
         this(var2, var3, var4);
      }
   }
}
