...
public class EntityRenderer implements IResourceManagerReloadListener {
   ...
   private void loadShader(ResourceLocation resourceLocationIn) {
      try {
         ...
         logger.warn((String)("Failed to load shader: " + resourceLocationIn), (Throwable)var3);
         this.shaderIndex = shaderCount;
         this.useShader = false;
      } catch (JsonSyntaxException var4) {
         logger.warn((String)("Failed to load shader: " + resourceLocationIn), (Throwable)var4);
         this.shaderIndex = shaderCount;
         this.useShader = false;
      }
   ...
   public void getMouseOver(float partialTicks) {
      ...
      if(entity != null && this.mc.theWorld != null) {
         ...
         Vec3 vec33 = null;
         float f = 1.0F;
         List<Entity> list = this.mc.theWorld.getEntitiesInAABBexcluding(entity, entity.getEntityBoundingBox().addCoord(vec31.xCoord * d0, vec31.yCoord * d0, vec31.zCoord * d0).expand((double)f, (double)f, (double)f), Predicates.and(EntitySelectors.NOT_SPECTATING, new Predicate() {
