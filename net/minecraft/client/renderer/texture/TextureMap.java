   ...
   public void loadTextureAtlas(IResourceManager resourceManager) {
      ...
      for(Entry<String, TextureAtlasSprite> entry : this.mapRegisteredSprites.entrySet()) {
         ...
         try {
            ...
            logger.error((String)("Unable to parse metadata from " + resourcelocation1), (Throwable)var23);
            continue;
         } catch (IOException var24) {
            logger.error((String)("Using missing texture, unable to load " + resourcelocation1), (Throwable)var24);
            continue;
         }
