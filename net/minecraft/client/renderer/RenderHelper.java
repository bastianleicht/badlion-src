...
public class RenderHelper {
   ...
   public static void enableStandardItemLighting() {
      ...
      GL11.glLight(16384, 4609, (FloatBuffer)setColorBuffer(f1, f1, f1, 1.0F));
      GL11.glLight(16384, 4608, (FloatBuffer)setColorBuffer(0.0F, 0.0F, 0.0F, 1.0F));
      GL11.glLight(16384, 4610, (FloatBuffer)setColorBuffer(f2, f2, f2, 1.0F));
      GL11.glLight(16385, 4611, (FloatBuffer)setColorBuffer(LIGHT1_POS.xCoord, LIGHT1_POS.yCoord, LIGHT1_POS.zCoord, 0.0D));
      GL11.glLight(16385, 4609, (FloatBuffer)setColorBuffer(f1, f1, f1, 1.0F));
      GL11.glLight(16385, 4608, (FloatBuffer)setColorBuffer(0.0F, 0.0F, 0.0F, 1.0F));
      GL11.glLight(16385, 4610, (FloatBuffer)setColorBuffer(f2, f2, f2, 1.0F));
      GlStateManager.shadeModel(7424);
      GL11.glLightModel(2899, (FloatBuffer)setColorBuffer(f, f, f, 1.0F));
   }
