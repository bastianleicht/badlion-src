...
public class RenderChunk {
   ...
   private EnumMap field_181702_p = Maps.newEnumMap(EnumFacing.class);
   ...
   public void rebuildChunk(float x, float y, float z, ChunkCompileTaskGenerator generator) {
      ...
      if(!iblockaccess.extendedLevelsInChunkCache()) {
         ...
         EnumWorldBlockLayer[] var32;
         for(EnumWorldBlockLayer enumworldblocklayer : var32 = EnumWorldBlockLayer.values()) {
