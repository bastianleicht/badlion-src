...
public class ModelBakery {
   ...
   private void loadVariants(Collection p_177591_1_) {
      for(ModelResourceLocation modelresourcelocation : p_177591_1_) {
         try {
            ...
            LOGGER.warn((String)("Unable to load definition " + modelresourcelocation), (Throwable)var7);
         }
      }
         ...
         for(ModelBlockDefinition.Variant modelblockdefinition$variant : ((ModelBlockDefinition.Variants)this.variants.get(modelresourcelocation)).getVariants()) {
            ...
            if(this.models.get(resourcelocation) == null) {
               try {
                  ...
                  LOGGER.warn((String)("Unable to load block model: \'" + resourcelocation + "\' for variant: \'" + modelresourcelocation + "\'"), (Throwable)var7);
               }
            }
         }
      }
         ...
         for(String s : this.getVariantNames(item)) {
            ...
            if(this.models.get(resourcelocation) == null) {
               try {
                  ...
                  LOGGER.warn((String)("Unable to load item model: \'" + resourcelocation + "\' for item: \'" + Item.itemRegistry.getNameForObject(item) + "\'"), (Throwable)var7);
               }
            }
         }
      }
   ...
   private void registerVariantNames() {
      ...
      this.variantNames.put(Items.fishing_rod, Lists.newArrayList((Object[])(new String[]{"fishing_rod", "fishing_rod_cast", "7_fishing_rod", "7_fishing_rod_cast"})));
   ...
   private void loadModels() {
      ...
      while(!((Deque)deque).isEmpty()) {
         ...
         try {
            ...
            LOGGER.warn((String)("In parent chain: " + JOINER.join((Iterable)this.getParentPath(resourcelocation2)) + "; unable to load model: \'" + resourcelocation2 + "\'"), (Throwable)var6);
         }
