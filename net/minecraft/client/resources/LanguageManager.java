   ...
   public void parseLanguageMetadata(List p_135043_1_) {
      ...
      for(IResourcePack iresourcepack : p_135043_1_) {
         try {
            ...
            logger.warn((String)("Unable to parse metadata section of resourcepack: " + iresourcepack.getPackName()), (Throwable)var7);
         } catch (IOException var8) {
            logger.warn((String)("Unable to parse metadata section of resourcepack: " + iresourcepack.getPackName()), (Throwable)var8);
         }
      }
