...
public abstract class GuiScreen extends Gui implements GuiYesNoCallback {
   ...
   private static final Set PROTOCOLS = Sets.newHashSet((Object[])(new String[]{"http", "https"}));
      ...
      if(p_175272_1_ != null && p_175272_1_.getChatStyle().getChatHoverEvent() != null) {
         ...
         if(hoverevent.getAction() == HoverEvent.Action.SHOW_ITEM) {
            ...
            if(statbase != null) {
               ...
               List<String> list = Lists.newArrayList((Object[])(new String[]{ichatcomponent.getFormattedText(), ichatcomponent1.getFormattedText()}));
               if(s1 != null) {
         ...
         if(isShiftKeyDown()) {
            ...
            if(clickevent.getAction() == ClickEvent.Action.OPEN_URL) {
               ...
               try {
                  ...
                  LOGGER.error((String)("Can\'t open url for " + clickevent), (Throwable)var5);
               }
