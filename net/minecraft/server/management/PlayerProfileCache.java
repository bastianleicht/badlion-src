...
public class PlayerProfileCache {
   ...
   public void load() {
      ...
      try {
         ...
         List<PlayerProfileCache.ProfileEntry> list = (List)this.gson.fromJson((Reader)bufferedreader, (Type)TYPE);
         ...
         if(p_deserialize_1_.isJsonObject()) {
            ...
            if(jsonelement != null && jsonelement1 != null) {
               ...
               if(s1 != null && s != null) {
                  ...
                  PlayerProfileCache.ProfileEntry playerprofilecache$profileentry = var10002.new ProfileEntry(new GameProfile(uuid, s1), date, (PlayerProfileCache.ProfileEntry)null);
                  return playerprofilecache$profileentry;
               } else {
                  return null;
               }
