...
final class XXHash64JavaUnsafe extends XXHash64 {
   ...
   public long hash(byte[] buf, int off, int len, long seed) {
      ...
      if(len >= 32) {
         ...
         while(true) {
            v1 = v1 + UnsafeUtils.readLongLE(buf, off) * -4417276706812531889L;
            v1 = Long.rotateLeft(v1, 31);
            v1 = v1 * -7046029288634856825L;
            off = off + 8;
            v2 = v2 + UnsafeUtils.readLongLE(buf, off) * -4417276706812531889L;
            v2 = Long.rotateLeft(v2, 31);
            v2 = v2 * -7046029288634856825L;
            off = off + 8;
            v3 = v3 + UnsafeUtils.readLongLE(buf, off) * -4417276706812531889L;
            v3 = Long.rotateLeft(v3, 31);
            v3 = v3 * -7046029288634856825L;
            off = off + 8;
            v4 = v4 + UnsafeUtils.readLongLE(buf, off) * -4417276706812531889L;
      ...
      if(off <= end - 4) {
         h64 = h64 ^ ((long)UnsafeUtils.readIntLE(buf, off) & 4294967295L) * -7046029288634856825L;
         h64 = Long.rotateLeft(h64, 23) * -4417276706812531889L + 1609587929392839161L;
         off += 4;
      }

      while(off < end) {
         h64 = h64 ^ (long)(UnsafeUtils.readByte(buf, off) & 255) * 2870177450012600261L;
