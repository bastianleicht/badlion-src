...
public class TarArchiveEntry implements TarConstants, ArchiveEntry {
   ...
   public TarArchiveEntry(File file, String fileName) {
      ...
      if(file.isDirectory()) {
         ...
         if(nameLength != 0 && fileName.charAt(nameLength - 1) == 47) {
            this.name = fileName;
         } else {
            this.name = fileName + "/";
         }
   ...
   public boolean isDirectory() {
      return this.file != null?this.file.isDirectory():(this.linkFlag == 53?true:this.getName().endsWith("/"));
   }

   public boolean isFile() {
      return this.file != null?this.file.isFile():(this.linkFlag != 0 && this.linkFlag != 48?!this.getName().endsWith("/"):true);
   }
   ...
   public void writeEntryHeader(byte[] outbuf, ZipEncoding encoding, boolean starMode) throws IOException {
      ...
      offset = this.writeEntryHeaderField((long)this.userId, outbuf, offset, 8, starMode);
      offset = this.writeEntryHeaderField((long)this.groupId, outbuf, offset, 8, starMode);
      ...
      if(osname != null) {
         if(osname.startsWith("windows")) {
            if(fileName.length() > 2) {
               ...
               if(ch2 == 58 && (ch1 >= 97 && ch1 <= 122 || ch1 >= 65 && ch1 <= 90)) {
   ...
   private int evaluateType(byte[] header) {
      return ArchiveUtils.matchAsciiBuffer("ustar ", header, 257, 6)?2:(ArchiveUtils.matchAsciiBuffer("ustar\u0000", header, 257, 6)?3:0);
   }
}
