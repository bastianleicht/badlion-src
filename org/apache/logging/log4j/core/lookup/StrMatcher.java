...
public abstract class StrMatcher {
   ...
   public static StrMatcher charSetMatcher(String chars) {
      return (StrMatcher)(Strings.isEmpty(chars)?NONE_MATCHER:(chars.length() == 1?new StrMatcher.CharMatcher(chars.charAt(0)):new StrMatcher.CharSetMatcher(chars.toCharArray())));
   }
