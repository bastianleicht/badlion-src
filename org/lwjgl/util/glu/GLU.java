...
public class GLU {
   ...
   public static final double GLU_TESS_MAX_COORD = 1.0E15D;
   public static final double TESS_MAX_COORD = 1.0E15D;
   ...
   public static void gluOrtho2D(float left, float right, float bottom, float top) {
      GL11.glOrtho((double)left, (double)right, (double)bottom, (double)top, -1.0D, 1.0D);
   }
